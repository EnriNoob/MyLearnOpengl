...
// glfw: initialize and configure
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::translate(model, glm::vec3( cos(glfwGetTime()) /2, 0.0f, 0.0f));
        ...
        projection = glm::perspective(glm::radians(45.0f), (float)1280 / (float)800, 1.0f, 12.0f);
